# RESEARCH.md — AI Home Building Research Threads

Active and planned research topics. Each thread has a status, key sources, and article potential.

## Legend
- 🟢 **Published** — article written
...
### 1. 🟢 AI Generative Design for Residential Architecture
- Autodesk Dreamcatcher, Hypar, TestFit
- McKinsey 2024 construction tech report
...
### 10. 🟢 AI Project Management Tools
- ALICE Technologies, Buildots, Doxel, Procore AI
...
### 16. 🟢 Construction Workforce Crisis + Automation
- 500K job gap, 73% of firms can't hire
- Hadrian X, Built Robotics, ICON as supplements
...
## Adding New Threads
When you discover a new topic worth covering, add it here with:
